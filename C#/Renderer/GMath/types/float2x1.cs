...
public struct float2x1{
	...
	public static explicit operator float1x1(float2x1 m) { return new(m._m00); }
	public static implicit operator float2x1(float v) { return new(v); }
	public static explicit operator int2x1(float2x1 v) { return new((int)v._m00,(int)v._m10); }
	public static float2x1 operator -(float2x1 a) { return new(-a._m00,-a._m10); }
	public static float2x1 operator +(float2x1 a) { return new(+a._m00,+a._m10); }
	public static int2x1 operator !(float2x1 a) { return new(a._m00==0?1:0,a._m10==0?1:0); }
