...
{
    public class TunerBackLeft<V> : SceneObject<V> where V : struct, INormalVertex<V>, ICoordinatesVertex<V>
    {
        ...
        public TunerBackLeft(Transform transform) : base(transform)
        {
            ...
            var crank = GetCrank()
                .Transform(Transforms.DesiredTransform(
                    translation: cylinder.Center() + float3.left,
                    eulerRotation: float3(0, 0, -pi / 2),
